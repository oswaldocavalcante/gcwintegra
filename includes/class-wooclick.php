...
class Wooclick {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wooclick_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WOOCLICK_VERSION' ) ) {
			$this->version = WOOCLICK_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wooclick';
	 ...
	 *
	 * - Wooclick_Loader. Orchestrates the hooks of the plugin.
	 * - Wooclick_i18n. Defines internationalization functionality.
	 * - Wooclick_Admin. Defines all hooks for the admin area.
	 * - Wooclick_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wooclick-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wooclick-i18n.php';
	 ...
	 *
	 * Uses the Wooclick_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wooclick_Loader    Orchestrates the hooks of the plugin.
	 */
