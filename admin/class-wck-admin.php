...
class WCK_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wooclick-admin.css', array(), $this->version, 'all' );
	...
	public function add_admin_menu() {
		add_menu_page(
			...
			'manage_options',
			'wooclick',
			array($this, 'wooclick_display_products'),
		...
		add_submenu_page( 
			...
			'manage_options',
			'wooclick-categories', 
			array($this, 'wooclick_display_categories'),
			2,
		);
