...
include_once WP_PLUGIN_DIR . '/wooclick/admin/woocommerce/class-wck-wc-products.php';
include_once WP_PLUGIN_DIR . '/wooclick/admin/woocommerce/class-wck-wc-categories.php';
include_once WP_PLUGIN_DIR . '/wooclick/admin/woocommerce/class-wck-wc-attributes.php';

include_once WP_PLUGIN_DIR . '/wooclick/admin/gestaoclick/class-wck-gc-venda.php';
...
class WCK_Admin {
	...
	public function add_integration( $integrations ) {
		...
		if ( $this->is_woocommerce_active() ) {
			include_once WP_PLUGIN_DIR . '/wooclick/admin/class-wck-wc-integration.php';
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'assets/css/wooclick-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'assets/js/wooclick-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function register_settings() {
		...
		register_setting('wck_settings', 	'wck-settings-export-orders', 			'boolean');
		register_setting('wck_settings', 	'wck-settings-export-transportadora', 	'string');
		register_setting('wck_settings', 	'wck-settings-export-situacao',		 	'string');
	}
	...
	public function display_products() {
		$this->products = new WCK_WC_Products();
	...
	public function display_categories() {
		$this->categories = new WCK_WC_Categories();
	...
	public function display_attributes() {
		$this->attributes = new WCK_WC_Attributes();
