...
class GCWC_Admin 
{
	...
	public function add_admin_menu()
	{
		...
		( 
			...
			function() 
			{
				$url = admin_url('admin.php?page=wc-settings&tab=integration&section=gcwc');
				wp_redirect($url);
				exit;
			},
			10,
	...
	public function display_products()
	{
		...
		{
			require_once plugin_dir_path(dirname(__FILE__)) . 'admin/views/gcwc-admin-page-products.php';
		} 
		else 
		{
			wp_admin_notice(__('GestãoClick: configure suas credenciais de acesso.', 'gcwc'), array('type' => 'error', 'dismissible' => true));
		}
	}
	...
	public function display_categories()
	{
		...
		{
			require_once plugin_dir_path(dirname(__FILE__)) . 'admin/views/gcwc-admin-page-categories.php';
		} 
		else 
		{
			wp_admin_notice(__('GestãoClick: configure suas credenciais de acesso.', 'gcwc'), array('type' => 'error', 'dismissible' => true));
	...
	{
		$this->attributes = new GCWC_WC_Attributes();
		
		if($this->attributes::test_connection()) 
		{
			require_once plugin_dir_path(dirname(__FILE__)) . 'admin/views/gcwc-admin-page-attributes.php';
		} 
		else 
		{
			wp_admin_notice(__('GestãoClick: configure suas credenciais de acesso.', 'gcwc'), array('type' => 'error', 'dismissible' => true));
